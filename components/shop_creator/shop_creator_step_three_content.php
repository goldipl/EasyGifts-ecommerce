<form class="shopcreator-content container">
    ...
    <p class="mt-2">Wpisz adresy kierujące do Twoich profili w mediach społecznościowych, wówczas na stronie głównej pojawią się ikony
wybranych portali wraz z linkami kierującymi do nich.
</p>
<div class="shopcreator-labels d-flex flex-row flex-wrap gap-3">
        <div class="d-flex flex-column label-box">
